/** 
  All of the routes for the ProjectHub Dashboard PRO React are added here,
...
// ProjectHub Dashboard PRO React layouts
...
import PricingPage from "layouts/dashboards/pricing-page";
import CRM from "layouts/dashboards/crm";
import ProfileOverview from "layouts/pages/profile/profile-overview";
import Teams from "layouts/pages/profile/teams";
import Endpoints from "layouts/dashboards/endpoints-page";
import Nodes from "layouts/dashboards/nodes-page";
...
import Ethereum from "layouts/pages/projects/ethereum";
import Polygon from "layouts/pages/projects/polygon";
import Xinfin from "layouts/pages/projects/xinfin";
import Pulsechain from "layouts/pages/projects/pulsechain";
...
// ProjectHub Dashboard PRO React icons
...
const routes = [
  {
    ...
    collapse: [
...

      {
        name: "Endpoints",
        key: "all-projects",
        route: "/dashboards/endpoints-page",
        component: <Endpoints />,
      },
      {
        name: "Nodes",
        key: "nodes-page",
        route: "/dashboards/nodes-page",
        component: <Nodes />,
      },
        ...
        collapse: [
          {
            name: "Ethereum",
            key: "ethereum",
            route: "/pages/projects/ethereum",
            component: <Ethereum />,
          },
          {
            name: "Polygon",
            key: "polygon",
            route: "/pages/projects/polygon",
            component: <Polygon />,
          },
          {
            name: "Xinfin",
            key: "xinfin",
            route: "/pages/projects/xinfin",
            component: <Xinfin />,
          },
          {
            name: "Pulsechain",
            key: "pulsechain",
            route: "/pages/projects/pulsechain",
            component: <Pulsechain />,
          },
          // {
          //   name: "Project Ai",
          //   key: "timeline",
 ...
 //   ],
  ...
  {
    type: "collapse",
    name: "Project Pi Docs",
    key: "Documentation",
    href: "https://project-pi.gitbook.io/documentation/welcome-to-project-pi/what-is-project-pi",
