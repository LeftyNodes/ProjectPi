...
/* ReCaptch Secret */
$recaptchaSecret = '6LeEDMQoAAAAAFbMfRQR6O9Bg8aAA9n5lLmOOsas';

$dzEmailTo 		= "leftynodes@gmail.com";   /* Receiver Email Address */
$dzEmailFrom    = "ProjectPi Contact";
...
function smtp_mail($dzEmailTo, $dzEmailFrom, $dzEmail, $dzMailSubject, $dzMailMessage)
{
    ...
    $mail->Username   = 'leftynodes@gmail.com';                   //SMTP username
    $mail->Password   = 'ProjectPi0220';                        //SMTP password
